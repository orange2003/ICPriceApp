...
#import "InOutDetailsViewController.h"
#import "QuoteInquiryListDelegate.h"
#import "InOutDetailsDataSource.h"

#define BUTTON_LEFT_MARGIN 10.0
#define BUTTON_SPACING 25.0
@interface InOutDetailsViewController (PrivateStuff)
-(void) setupSideSwipeView;
@end

@implementation InOutDetailsViewController
...
-(void)loadView{
    ...
    self.dataSource = [[[InOutDetailsDataSource alloc] init] autorelease];
}
